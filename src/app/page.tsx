...
import { createTask, createUpdate, deleteRecord, editUpdate, updateTask, workspaceData } from "./actions";
...
function Placeholder({ title }: { title: string }) {
  return <section className="panel placeholder"><p className="eyebrow">KAJA workspace</p><h1>{title}</h1><p>This section is being prepared for the team.</p><span>Coming soon</span></section>;
}
